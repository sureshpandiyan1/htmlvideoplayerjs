...
function playpauseN(video, playnpause, play, pause, folderpath) {
  ...
  function gez(video,vbar) {
    const VD = document.getElementById(video)
    document.getElementById(vbar).value = Math.floor(VD.currentTime)
    setInterval(gez, 1000)
  }
  ...
  function mfullscreen(setz,vsettings,video){
    document.getElementById(setz+vsettings).addEventListener('click', function() {
